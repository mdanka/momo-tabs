// From https://github.com/ianstormtaylor/slate/pull/2144
...
declare module "slate" {
    ...
    class ElementInterface {
        ...
        mapDescendants(iterator: (node: Node, i: number, descendants: Immutable.List<Node>) => Node): Node;
        mergeNode(path: Path | PathJSON | string): Node;
        moveNode(path: Path | PathJSON | string, newPath: Path | PathJSON | string, newIndex: number): Node;
    ...
    export interface Document extends DeepImmutable<DocumentProperties>, ElementInterface, NodeInterface {}
    export class Document extends Immutable.Record({
        ...
        static create(document: Document | Partial<DocumentProperties> | Immutable.List<Node> | Array<Node>): Document;
    ...
    export interface Inline extends DeepImmutable<InlineProperties>, ElementInterface, NodeInterface {}
    ...
    export class Text {
        ...
        searchLeafAtOffset(offset: number): { startOffset: number; endOffset: number; index: number; leaf?: Leaf };
        ...
        setLeaves(leaves: Array<Leaf | Partial<LeafProperties>> | Immutable.List<Leaf | Partial<LeafProperties>>): Text;
    ...
    export class Leaf extends Immutable.Record({
        ...
        static createLeaves(
            leaves: Array<Leaf | Partial<LeafProperties>> | Immutable.List<Leaf | Partial<LeafProperties>>,
        ): Immutable.List<Leaf>;
    ...
    export class Point extends Immutable.Record({
        ...
        static create(point: Point | Partial<PointProperties> | Immutable.List<Node> | Array<Node>): Point;
        static createProperties(point: Partial<PointJSON> | Partial<PointProperties> | Point): PointProperties;
    ...
    export class Decoration {
        ...
        static create(attrs: Decoration | Range | Partial<DecorationProperties> | Partial<DecorationJSON>): Decoration;
        static createList(
            elements:
                | Immutable.List<Decoration | Range | Partial<DecorationProperties> | Partial<DecorationJSON>>
    ...
    export class Range {
        ...
        static createProperties(a: Range | Range | Partial<RangeProperties> | Partial<RangeJSON>): RangeProperties;
    ...
    export class Selection {
        ...
        static create(attrs: Selection | Range | Partial<SelectionProperties> | Partial<SelectionJSON>): Selection;
        static createProperties(
    ...
    export class Change /*TODO: Naming conflict on delte - extends Immutable.Record({}) */ {
        ...
        getFlag(key: keyof ChangeProperties["flags"], options: Partial<ChangeProperties["flags"]>): boolean;
    ...
    interface ChangesAtCurrentRange {
        ...
        addMarks(marks: Immutable.List<Mark> | Array<Mark | Partial<MarkProperties> | Partial<MarkJSON>>): Change;
        delete(): Change;
    ...
    interface ChangesAtRange<Options = { normalize?: boolean }> {
        ...
        addMarksAtRange(range: Range, marks: Immutable.List<Mark> | Array<Mark>, options?: Options): Change;
        ...
        insertTextAtRange(range: Range, text: string, marks?: Immutable.Set<Mark>, options?: Options): Change;
        removeMarkAtRange(
            range: Range,
    ...
    interface ChangesByPath<Options = { normalize?: boolean }> {
        ...
        setNodeByPath(path: Path, properties: Partial<NodeProperties> | Partial<NodeJSON>, options?: Options): Change;
        ...
        splitDescendantsByPath(path: Path, textPath: Path, textOffset: number, options?: Options): Change;
        unwrapInlineByPath(
            path: Path,
            properties: Partial<InlineProperties> | Partial<InlineJSON>,
            options?: Options,
    ...
    export class Value {
        ...
        static create(value: Value | Partial<ValueProperties> | Immutable.List<Node> | Array<Node>): Value;
        static createProperties(point: Partial<ValueJSON> | Partial<ValueProperties> | Value): ValueProperties;
        ...
        splitNode(path: Path, position: number, propterties: Partial<NodeProperties> | Partial<NodeJSON>): Value;
